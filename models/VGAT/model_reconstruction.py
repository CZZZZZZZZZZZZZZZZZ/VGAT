...
from .util import *
from .reconstruction_attention_modules import *
...
class Reconstruction_Net(nn.Module):
    def __init__(self, omic_sizes=[256], num_tokens=1, dropout=0.25):
        ...
        self.path_filter = SoftFilterLayer(512,hidden_size=512,deep=1)
    ...
    def forward(self, **kwargs):
        ...
        h_path_bag = self.path_filter(h_path_bag)
